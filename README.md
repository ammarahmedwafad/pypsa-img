...
```
Wafad, A. A. (2026). PyPSA-IMG: An open optimisation model for the design and assessment
of islanded, hydrogen-integrated microgrids (v1.0) [Software]. GitHub. (Zenodo DOI to follow.)
```
